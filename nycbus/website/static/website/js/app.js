...
app.pictureBook = function() {
    ...
    this.books = [].map.call(document.querySelectorAll(".picture-book"), function(d) {
        return {
            ...
            pages: [].map.call(d.querySelectorAll(".picture-book-page"), function(page) {
                return { node: page }; })
        };
    });
